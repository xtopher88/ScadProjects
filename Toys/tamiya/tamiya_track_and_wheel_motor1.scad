...
module base1()
{
    ...
    difference()
    {
        union()
        {
            ...
            // screw suports
            translate([-51.5,(screw_spacing+7)/2,19.2]) cube([25,2,11],center=true);
            translate([-51.5,-(screw_spacing+7)/2,19.2]) cube([25,2,11],center=true);
            // front and rear bumper
            d_bumper = 5;
            bumper_height = 14.5;
            translate([64,0,idler_wheel_height+33-d_bumper]) rotate([90,0,0]) cylinder(16*4,d_bumper,d_bumper,center=true);
            translate([64,0,idler_wheel_height+33-d_bumper-bumper_height/2]) cube([d_bumper*2,16*4,bumper_height],center=true);
            // side rails
            translate([13,wheel_base/2-1,-7]) cube([111,6,35],center=true);
            translate([13,-wheel_base/2+1,-7]) cube([111,6,35],center=true);
            translate([10,0,-15/2+10.5]) cube([105,16*4,15],center=true);
        }
        ...
        translate([-55,0,gear_block_height/2-6]) cube([25,16*4+1,gear_block_height],center=true);
    ...
    diameter = 14.2;
        ...
        %translate([30,-16/2,7]) rotate([0,90,0]) aa();
        translate([31+(length+2)/2,16/2,7]) cylinder(30,1,1,center=true);
        translate([31-(length+2)/2,16/2,7]) cylinder(30,1,1,center=true);
        translate([31+(length+2)/2,-16/2,7]) cylinder(30,1,1,center=true);
        translate([31-(length+2)/2,-16/2,7]) cylinder(30,1,1,center=true);
    }
